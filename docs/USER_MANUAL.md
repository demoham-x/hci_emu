...
7. [FAQ](#faq)
8. [App API Reference](#app-api-reference)
...
For non-interactive, script-driven usage of `BLETestingApp` in `src/app.py`, see:

- [APP_API_REFERENCE.md](APP_API_REFERENCE.md)

This reference documents method signatures, parameter values, and usage guidance for all app-facing APIs.
